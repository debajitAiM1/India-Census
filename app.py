...
st.sidebar.title('Indian Census (BETA)')
...
if plot:
    ...
    if state=='Overall India':
        st.subheader('V 1.0.1')
        st.sidebar.write('- Size Represent Primary Parameter')
        st.sidebar.write('- Color Represent Secondary Parameter')
